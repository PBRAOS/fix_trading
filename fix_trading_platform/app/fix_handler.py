...
initiator = None  # Will hold the SocketInitiator instance
...
class Application(fix.Application):
    ...
    def toAdmin(self, message, sessionID):
        print("➡️  Sending admin message:", message.toString())

    def fromAdmin(self, message, sessionID):
        print("⬅️  Received admin message:", message.toString())

    def toApp(self, message, sessionID):
        print("➡️  Sent app message:", message.toString())

    def fromApp(self, message, sessionID):
        print("⬅️  Received app message:", message.toString())
